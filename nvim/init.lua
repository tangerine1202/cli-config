...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    dependencies = {
      ...
      -- Sort the file search results by recency.
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>so', builtin.oldfiles, { desc = '[S]earch Recent [O]pened Files' }) -- ("." for repeat)
      vim.keymap.set('n', '<leader><leader>', function()
        require('telescope').extensions['recent-files'].recent_files {}
      end, { desc = '[Search] [F]iles in Recent' })
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      -- Customize statueline, see https://github.com/echasnovski/mini.nvim/discussions/1177#discussioncomment-10454003
      local my_statusline_content = function()
        local diag_signs = { ERROR = '󰅚 ', WARN = '󰀪 ', INFO = '󰋽 ', HINT = '󰌶 ' }
        -- statusline content
        local mode, mode_hl = MiniStatusline.section_mode { trunc_width = 4096 }
        local git = MiniStatusline.section_git { trunc_width = 40 }
        local diff = MiniStatusline.section_diff { trunc_width = 75 }
        local diagnostics = MiniStatusline.section_diagnostics { trunc_width = 75, signs = diag_signs, icon = '' } -- icon = ''
      ...
      statusline.setup {
        ...
        content = { active = my_statusline_content },
      }
